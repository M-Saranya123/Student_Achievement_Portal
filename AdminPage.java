...
public class AdminPage extends JFrame { private JTextArea achievementArea;
...
// Method to load all achievements from the database private void loadAllAchievements() {
achievementArea.setText("");
try (Connection conn = DBConnection.getConnection()) {
 
String sql = "SELECT USERNAME, EVENT_NAME, EVENT_DATE, STATUS, CERTIFICATE_LINK, CASH_PRIZE FROM ACHIEVEMENTS";
...
String achievementInfo = "Username: " + username +
"\nEvent: " + eventName + "\nDate: " + eventDate + "\nStatus: " + status +
