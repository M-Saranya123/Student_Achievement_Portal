...
public class LoginPage extends JFrame { private JTextField usernameField; private JPasswordField passwordField;
private JButton loginButton, signupButton; private Connection conn;

public LoginPage() {
// Set up the frame setTitle("Login Page"); 
setSize(400, 200);
...
add(signupButton);
// Add login button action loginButton.addActionListener(new ActionListener() {
public void actionPerformed(ActionEvent e) { 
login();
}
});
// Add signup button action signupButton.addActionListener(new ActionListener() {
public void actionPerformed(ActionEvent e) { 
new SignupPage(); 
// Open signup page dispose(); 
// Close login page
}
});
